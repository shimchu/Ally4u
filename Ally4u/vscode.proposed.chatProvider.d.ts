...
declare module 'vscode' {
	...
	*/
	export interface LanguageModelChatProvider {
		...
		provideLanguageModelResponse(messages: Array<LanguageModelChatMessage | LanguageModelChatMessage>, options: LanguageModelChatRequestOptions, extensionId: string, progress: Progress<ChatResponseFragment2>, token: CancellationToken): Thenable<any>;

		provideTokenCount(text: string | LanguageModelChatMessage | LanguageModelChatMessage, token: CancellationToken): Thenable<number>;
	}
